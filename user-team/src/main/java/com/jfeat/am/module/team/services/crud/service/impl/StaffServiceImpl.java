...
//import com.jfeat.am.uaas.system.services.persistence.dao.SysUserRoleMapper;
//import com.jfeat.am.uaas.system.services.persistence.model.SysUserRole;
...
//    SysUserMapper sysUserMapper;
    ...
    public Staff queryStaffByUserId(long userId) {
        ...
        return staffMapper.selectOne(staffQueryWrapper);
    }
    ...
    public Integer createStaffModel(StaffModel entity) {
        int affected = 0;
//        SysUser sysUser = sysUserService.register(entity.getSysUser().getAccount(),entity.getOrgId(), entity.getSysUser().getName(), entity.getSysUser().getPassword());
