...
import static com.jfeat.am.module.team.api.model.PowerBusinessCode.PowerBusinessBadRequest;
...
public class StaffTeamServiceImpl extends CRUDServicePeerImpl<Staff,Team,StaffTeam> implements StaffTeamService {
    ...
    * */
    ...
    public Integer deleteTeam(long id){
        List<StaffTeam> staffTeams = staffTeamMapper.selectList(new QueryWrapper<StaffTeam>().eq(StaffTeam.TEAMID,id));
