...
@Api(value = "工作任务")
@RestController
@RequestMapping("/api/u/task/taskfollower")
public class AppTaskFollowerEndpoint {
    ...
    public Tip assignStaffFollowTask(@PathVariable Long id, @RequestBody StaffId entity) {
        ...
        if(!teamPatchService.isStaffTeamLeader(follower.getTeamId(),staff.getId())){
            throw new BusinessException(BusinessCode.PowerBusinessCodeBase,"You are not the leader in the team!");
        }
